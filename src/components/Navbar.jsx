  ...
  return (
    <>
      <nav className={nav ? "nav active" : "nav"}>
        ...
        <ul className="menu">
          <li><Link to="main" smooth={true} duration={1000} activeClass="active" spy={true}>Home</Link></li>
          <li><Link to="about" smooth={true} duration={1000} activeClass="active" spy={true}>About</Link></li>
          <li><Link to="art" smooth={true} duration={1000} activeClass="active" spy={true}>Our Art</Link></li>
          <li><Link to="feature" smooth={true} duration={1000} activeClass="active" spy={true}>Features</Link></li>
          <li><Link to="car" smooth={true} duration={1000} activeClass="active" spy={true}>Careers</Link></li>
